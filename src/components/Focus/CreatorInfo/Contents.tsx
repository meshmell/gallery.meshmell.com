...
const CreatorInfo = ({ creatorsObj, lang, isFocusedMode }: CreatorInfoType) => {
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      {isFocusedMode &&
        <div className="flex items-center gap-2 select-none mt-4 sm:mt-8" onClick={handleGotoFilter}>
          <div className="text-base cursor-pointer" >{t("creatorInfo.seeMoreModels")}</div>
