...
const CreatorFilterButton = ({ setModalOpen, modalOpen, filteredCreatorsObj, lang }: CreatorFilterButtonType) => {
  ...
  return (
    <>
      ...
      >
        <div className={`${modalOpen.creatorFilter ? "bg-blue-500 border-blue-500" : "bg-neutral-100 dark:bg-neutral-950 border-black dark:border-white "} px-[4px] sm:px-[8px] flex justify-center items-center h-12 sm:h-14 border-[1.5px] sm:border-[3px] rounded-[18px] sm:rounded-[24px]`} >
          <RiFilter3Fill className={`${modalOpen.creatorFilter ? "text-white" : "text-black dark:text-white"} text-3xl sm:text-4xl`} />
