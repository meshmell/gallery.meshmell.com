    ...
    <>
      <div className="fixed top-0 left-0 w-full bg-transparent z-50">
        <div className="flex justify-center sm:justify-end gap-1 sm:gap-4 2xs:gap-4 mx-[0.5vw] ">
          ...
          {isFocusedMode &&
            <WireFrameSwitchButton lang={lang} setIsWireFrame={setIsWireFrame} isWireFrame={isWireFrame} />
          }
          <CategoryFilterButton setModalOpen={setModalOpen} filteredCategorysObj={filteredCategorysObj} modalOpen={modalOpen} />
          <CreatorFilterButton lang={lang} setModalOpen={setModalOpen} filteredCreatorsObj={filteredCreatorsObj} modalOpen={modalOpen} />
      ...
      <SearchButton lang={lang} setModalOpen={setModalOpen} searchWord={searchWord} modalOpen={modalOpen} setSearchWord={setSearchWord} />
    </ >
  )
}
