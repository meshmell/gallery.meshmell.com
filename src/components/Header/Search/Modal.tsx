        ...
        <form onSubmit={handleSubmit} className='mt-8 mb-12'>
          <div className='flex w-full'>
            ...
            <button
              aria-label='Search'
              type='submit'
              className='flex justify-center items-center rounded-r-lg bg-neutral-100 dark:bg-neutral-950 p-0 border-y border-r border-black dark:border-white text-black dark:text-white h-[40px] w-[40px]'
            >
              <FaSearch size='2rem' />
            </button>
          </div>
