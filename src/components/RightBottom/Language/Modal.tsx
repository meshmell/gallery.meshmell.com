...
const LanguageSwitchModal = ({ lang, setModalOpen, setHoverOnModal, modalOpen }: LanguageSwitchModalType) => {
  ...
  return (
    <>
      ...
      >
        ...
        <h2 className='text-2xl font-bold'>{t("languageSwitch.switchLanguage")}</h2>
